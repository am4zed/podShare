    ...
    return (
      ...
      <div className='home'>
        ...
        <section className ='home__section'>
          ...
          <div className='home__needhavediv'><Link to="/search">I need / Search</Link></div>
          <div className='home__needhavediv'><Link to="/offer">I have / Share</Link></div>
        </section>
        <section className ='home__section'>
        ...
        <section className='home__section'>
          ...
          <div className='home__categorydiv'><Link to="/pods/munrobaggers">Munrobaggers</Link></div>
          <div className='home__categorydiv'><Link to="/pods/cookingfiesta">CookingFiesta</Link></div>
          <div className='home__categorydiv'><Link to="/pods/codeclan">CodeClan</Link></div>
          <div className='home__categorydiv'><Link to="/pods/leithlinkshare">Leith Links Share</Link></div>
        </section>
      </div>
    </div>
    );
